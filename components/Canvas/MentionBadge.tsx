...
export const MentionBadge: React.FC<MentionBadgeProps> = ({ nodeTitle, onRemove }) => {
  return (
    <div className="absolute -top-8 left-0 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
